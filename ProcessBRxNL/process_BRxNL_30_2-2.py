...
aggregateWindow = 30 # in seconds #NB: still need to write warning in temporal aggregation in case you have Goals in combination with None.
...
parallelProcess = (2,2) # (nth process,total n processes) # default = (1,1)
