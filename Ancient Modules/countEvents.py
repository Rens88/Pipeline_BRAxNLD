...
if __name__ == '__main__':
	process(rawDict,attributeDict,TeamAstring,TeamBstring,exportData,exportDataString,exportFullExplanation)

	goals(targetEvents,TeamAstring,TeamBstring,exportData,exportDataString,exportFullExplanation,rowswithinrange)
...
def process(rawDict,attributeDict,TeamAstring,TeamBstring,exportData,exportDataString,exportFullExplanation):
...
def goals(targetEvents,TeamAstring,TeamBstring,exportData,exportDataString,exportFullExplanation):
