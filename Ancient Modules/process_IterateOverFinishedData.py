...
print(eventAggFolder)
print(aggregateEvent)
print(allWindows_and_Lags)
print(aggregatedOutputFilename)
print(aggregatePerPlayer)
print(outputFolder)
print(debuggingMode)
print(dataFolder)
...
iterateWindowsOverEventAgg.process(aggregateLevel,eventAggFolder,aggregateEvent,allWindows_and_Lags,aggregatedOutputFilename,aggregatePerPlayer,outputFolder,debuggingMode,dataFolder)
