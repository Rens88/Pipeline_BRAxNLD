...
if __name__ == '__main__':
	...
	exportClean(dataFiles,folder,TeamAstring,TeamBstring)
#########################################################################

def exportClean(dataFiles,folder,TeamAstring,TeamBstring):
	...
	for fname in dataFiles:
		with open(folder+fname, 'r') as infile:
			...
			with open(folder+'corrected\\' + newfname,'w',newline='') as outfile:
