...
def goals(window,aggregateEvent,targetEvents,refTeam,othTeam,exportData,exportDataString,exportFullExplanation):
	...
	noGoalsInfo = False
	if not 'Goal' in targetEvents.keys():
		# if goals doesn't exist
		noGoalsInfo = True
	...
	if noGoalsInfo:
		# no 'goals' information, return nothing.
		# goalCount = None
		# goalCountA = None
		# goalCountB = None
		# goalsDelta = None
...
def turnovers(window,aggregateEvent,targetEvents,refTeam,othTeam,exportData,exportDataString,exportFullExplanation):
	...
	noEventInfo = False
	if not 'Turnovers' in targetEvents.keys():
		# if goals doesn't exist
		noEventInfo = True
	...
	if noEventInfo:
		# no 'Turnovers' information, return nothing.
		# turnoverCount = None
		# turnoverCountA = None
		# turnoverCountB = None
		# turnoverDelta = None
...
def passes(window,aggregateEvent,targetEvents,refTeam,othTeam,exportData,exportDataString,exportFullExplanation):
	...
	noEventInfo = False
	if not 'Passes' in targetEvents.keys():
		# if goals doesn't exist
		noEventInfo = True
