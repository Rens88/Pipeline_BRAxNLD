...
aggregatePerPlayer = ['dist to closest visitor','distanceToOpponentGoal','distanceToOwnGoal','angleOpponentToPassline','distanceToInPossession','distanceToOpponentRating','angleToPasslineRating','distanceToPossessionRating','distanceToOpponentGoalRating'] # a list of outcome variables that you want to aggregated per player. For example: ['vNorm','distFrame']
...
plotTheseAttributes_atTrialLevel = ['dist to closest visitor','distanceToOpponentGoal','distanceToOwnGoal','angleOpponentToPassline','distanceToInPossession','distanceToOpponentRating','angleToPasslineRating']  #
...
plotTheseAttributes_atDatasetLevel = ['dist to closest visitor','distanceToOpponentGoal','distanceToOwnGoal','angleOpponentToPassline','distanceToInPossession','distanceToOpponentRating','angleToPasslineRating']
