...
def process(csvFolder,xmlFolder,saveFolder,checkVictor,checkLars,tsText,playerText,teamText,xText,yText,shirtText,possText,speedText):
	...
	folder = dirname(realpath(__file__)) + sep + 'Analyse' + sep
	...
	for dirtyFname in DirtyDataFiles:
		...
		excludeList = ['InBallPos','Shirt','Link_PressureFromDefender','Link_PressureZone','Link_SDDefender','playerInIZ','distToPlayerWithBall','angleInPossDefGoal']
		try:
